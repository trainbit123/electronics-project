...
const FEATURES = ['5G', 'Stylus Support', 'AMOLED Display', 'Cellular', 'Face Unlock']
...
function TabletsPage() {
  ...
  useEffect(() => {
    setLoading(true)
    fetch('https://dummyjson.com/products/category/tablets?limit=100')
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5">
        ...
        <nav className="flex items-center gap-1.5 text-xs text-gray-500 mb-4">
          ...
          <span className="text-gray-800 font-medium">Tablets</span>
        </nav>

        {/* Title + Sort row */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
          <div>
            <h1 className="text-xl font-bold text-gray-800">Tablets</h1>
          ...
          <div className="flex-1 min-w-0">
            ...
            {!error && !loading && displayProducts.length === 0 && (
              <div className="text-center py-20 text-gray-400">
                ...
                <p className="font-semibold text-gray-600 text-base">No tablets match your filters</p>
